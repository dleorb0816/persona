...
public interface CommentMapper {
	...
	@Insert("INSERT INTO comment (nno, id, content, re_ref, re_lev, re_seq, reg_date, update_date) "
			+ "VALUES (#{nno}, #{id}, #{content}, #{reRef}, #{reLev}, #{reSeq}, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)")
